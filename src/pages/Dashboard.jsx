...
import { FiActivity, FiClock, FiTrendingUp, FiSmile } from "react-icons/fi";
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Stat Card 1 */}
        <div className="p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xs hover:shadow-md transition-shadow flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left Column: Mood Form & Habit Tracker */}
              ...
              <div className="space-y-4">
                {moodHistory.map((entry) => {
                  ...
                  return (
                    <div
                      key={entry.id}
                      className="flex gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 transition-all hover:shadow-xs"
                    >
                      <div
